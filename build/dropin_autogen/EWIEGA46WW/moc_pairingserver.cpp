...
Q_CONSTINIT static const qt_meta_stringdata_PairingServer_t qt_meta_stringdata_PairingServer = {
    {
        ...
        QT_MOC_LITERAL(45, 13),  // "pairingFailed"
        QT_MOC_LITERAL(59, 6),  // "reason"
        QT_MOC_LITERAL(66, 15),  // "onNewConnection"
        QT_MOC_LITERAL(82, 14),  // "onDataReceived"
        QT_MOC_LITERAL(97, 20)   // "onClientDisconnected"
    },
    "PairingServer",
    "devicePaired",
    "",
...
void PairingServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->devicePaired((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[2]))); break;
        ...
        {
            using _t = void (PairingServer::*)(const QString & , const QString & );
...
// SIGNAL 0
void PairingServer::devicePaired(const QString & _t1, const QString & _t2)
{
